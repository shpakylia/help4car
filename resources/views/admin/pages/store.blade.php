...
@section('content')
    <div class="container">
        <div class="panel panel-default">
            ...
            <!-- New Task Form -->
                <form action="{{ url('admin/page') }}" method="POST" class="form-horizontal">
                {{ csrf_field() }}
                ...
                <!-- Task Name -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="title_uk" id="title_uk" class="form-control" value="{{ old('title_uk') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea name="text_ru" id="text_ru" class="form-control">{{ old('text_ru') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea name="text_uk" id="text_uk" class="form-control">{{ old('text_uk') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="seo_title_ru" id="seo_title_ru" class="form-control" value="{{ old('seo_title_ru') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="seo_title_uk" id="seo_title_uk" class="form-control" value="{{ old('seo_title_uk') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="seo_description_ru" id="seo_description_ru" class="form-control" value="{{ old('seo_description_ru') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="seo_description_uk" id="seo_descriptione_uk" class="form-control" value="{{ old('seo_descriptione_uk') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" name="order" id="order" class="form-control" value="{{ old('order') == null ? 0 : old('order') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <select name="is_active" id="is_active">
                                <option value="1" {{ old('is_active') == '1' ? "selected" : ''  }} >отображать</option>
                                <option value="0" {{ old('is_active') == '0' ? "selected" : ''  }}>скрыта</option>
                            </select>
                        </div>
                    </div>
